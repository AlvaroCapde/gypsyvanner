            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              ...
              <div className="lg:w-1/3 flex flex-col">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    { title: "Reglas de Registro", href: "/registro/documentos/reglas", icon: "M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z", color: "bg-blue-50 text-blue-700", hover: "hover:border-blue-200" },

          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-24">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-zinc-300 leading-relaxed font-light mb-10 max-w-2xl">
                Asegura el linaje de tu ejemplar y conviértete en parte de la historia. Empieza a registrar tu caballo hoy y obtén el prestigio y los beneficios del registro oficial inicial en México.
              </p>
            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              ...
              <div className="lg:w-2/3 flex flex-col">
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-zinc-200 flex-grow">
                  ...
                  <p className="text-zinc-500 mb-8">Lee cuidadosamente esta información antes de iniciar tu proceso de registro oficial.</p>
        ...
        <section id="formulario-registro" className="w-full bg-zinc-50 py-24 border-b border-zinc-100">
          <div className="w-full max-w-3xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-zinc-600 text-lg mb-10 leading-relaxed">
              Para registrar a tu caballo y garantizar su linaje como parte de los fundadores en México, el requisito indispensable es ser miembro activo de la GVHS.
            </p>
            <Link
              href="/#membresia"
